...
{
    [TestFixture,TestOf(typeof(FileDataWorker)),ExcludeFromCodeCoverage]
    public class FileDataWorkerTester
    {
        ...
        public void Setup()
        {
            ...
            MockFileStreamer
                ...
                .Returns(true);
            MockFileStreamer
                .Setup(x => x.WriteDataToStream("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data", ExpectedRetryBasicData))
                .Returns(true);
            MockFileStreamer
                .Setup(x => x.ReadDataFromStream<RetryBasicData>("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data"))
        ...
        public bool WriteFailsToWriteDataToStream()
        {
            ...
            MockFileStreamer.Verify(x => x.WriteDataToStream("BasicData\\" + ExpectedBasicData.Id + ".data",ExpectedBasicData), Times.Once);
        ...
        public bool WriteFailsToWriteDataToStreamWithRetry()
        {
            MockFileStreamer
                ...
                .Returns(false);
            var result = FileDataWorker.Write(ExpectedRetryBasicData.Id,ExpectedRetryBasicData);
            MockFileStreamer.Verify(x => x.GetLockForFile("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data"), Times.Exactly(3));
            MockFileStreamer.Verify(x => x.WriteDataToStream("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data",ExpectedRetryBasicData), Times.Exactly(3));
            MockFileStreamer.Verify(x => x.UnlockFile("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data"), Times.Exactly(3));
            return result;
        }
        ...
        {
            MockFileStreamer
                .SetupSequence(x => x.WriteDataToStream("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data", ExpectedRetryBasicData))
                .Returns(false)
                .Returns(true);
            var result = FileDataWorker.Write(ExpectedRetryBasicData.Id,ExpectedRetryBasicData);
            MockFileStreamer.Verify(x => x.GetLockForFile("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data"), Times.Exactly(2));
            MockFileStreamer.Verify(x => x.WriteDataToStream("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data",ExpectedRetryBasicData), Times.Exactly(2));
            MockFileStreamer.Verify(x => x.UnlockFile("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data"), Times.Exactly(1));
            return result;
        }
        ...
        public bool WriteAndCommitFailsToGetLock()
        {
            ...
            MockFileStreamer.Verify(x => x.DisposeOfStream("BasicData\\" + ExpectedBasicData.Id + ".data"),Times.Never);
            return result;
        }
        ...
        {
            MockFileStreamer
                .SetupSequence(x => x.ReadDataFromStream<RetryBasicData>("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data"))
                .Throws<Exception>()
                .Returns(ExpectedRetryBasicData);
            Assert.AreSame(ExpectedRetryBasicData,FileDataWorker.Read<RetryBasicData>(ExpectedRetryBasicData.Id));
            MockFileStreamer.Verify(x => x.UnlockFile("RetryBasicData\\" + ExpectedRetryBasicData.Id + ".data"), Times.Exactly(2));
        }
        ...
        public bool RestoreSoftDeleteDataReturnsTrue()
        {
            ...
            MockFileStreamer.Verify(x => x.Undelete("SoftDeleteData\\" + ExpectedSoftDeleteData.Id + ".data"), Times.Once);
            return result;
        }
