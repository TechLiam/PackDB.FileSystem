...
namespace PackDB.FileSystem.Tests
{
    ...
    public class AuditWorkerTester
    {
        ...
        private bool GetLockForFileFails(Expression<Func<bool>> methodUnderTest, Expression<Func<IAuditGenerator, AuditLog>> auditGenerator, Times retryAttempts)
        {
            MockFileStreamer
                .Setup(x => x.GetLockForFile("AuditableData\\" + ExpectedData.Id + ".audit"))
                .Returns(false);
            var result = methodUnderTest.Compile().Invoke();
            MockFileStreamer.Verify(x => x.GetLockForFile("AuditableData\\" + ExpectedData.Id + ".audit"), retryAttempts);
            MockFileStreamer.Verify(x => x.WriteDataToStream(It.IsAny<string>(),It.IsAny<AuditableData>()), Times.Never);
            MockFileStreamer.Verify(x => x.UnlockFile(It.IsAny<string>()), Times.Never);
            MockAuditGenerator.Verify(auditGenerator, Times.Never);
            return result;
        }
        private bool WriteDataToStreamFails(Expression<Func<bool>> methodUnderTest, Expression<Func<IAuditGenerator, AuditLog>> auditGenerator, AuditLog expectedAuditLog, Times retryAttempts, Times lockFile)
        {
            MockFileStreamer
            ...
            MockFileStreamer.Verify(x => x.WriteDataToStream("AuditableData\\" + ExpectedData.Id + ".audit",expectedAuditLog), retryAttempts);
            MockFileStreamer.Verify(x => x.UnlockFile(It.IsAny<string>()), lockFile);
            MockAuditGenerator.Verify(auditGenerator, retryAttempts);
            return result;
        }
        private bool WriteDataToStreamFailsDueToException(Expression<Func<bool>> methodUnderTest, Expression<Func<IAuditGenerator, AuditLog>> auditGenerator, AuditLog expectedAuditLog, Times retryAttempts, Times lockFile)
        {
            MockFileStreamer
                .Setup(x => x.WriteDataToStream("AuditableData\\" + ExpectedData.Id + ".audit",expectedAuditLog))
                .Throws<Exception>();
        ...
        private bool GenerateAuditFailsDueToException(Expression<Func<bool>> methodUnderTest, Expression<Func<IAuditGenerator, AuditLog>> auditGenerator, Times retryAttempts)
        {
            MockAuditGenerator
            ...
            var result = methodUnderTest.Compile().Invoke();
            MockFileStreamer.Verify(x => x.GetLockForFile("AuditableData\\" + ExpectedData.Id + ".audit"), retryAttempts);
            MockFileStreamer.Verify(x => x.WriteDataToStream("AuditableData\\" + ExpectedData.Id + ".audit",It.IsAny<AuditLog>()), Times.Never);
        ...
        private bool SuccessEvent(Expression<Func<bool>> methodUnderTest, Expression<Func<IAuditGenerator, AuditLog>> auditGenerator, AuditLog expectedAuditLog, Times getFileLockTimes, Times unlockFile)
        {
            MockFileStreamer
                .Setup(x => x.WriteDataToStream("AuditableData\\" + ExpectedData.Id + ".audit",expectedAuditLog))
                .Returns(true);
            var result = methodUnderTest.Compile().Invoke();
            MockFileStreamer.Verify(x => x.GetLockForFile("AuditableData\\" + ExpectedData.Id + ".audit"), getFileLockTimes);
            MockFileStreamer.Verify(x => x.WriteDataToStream("AuditableData\\" + ExpectedData.Id + ".audit",expectedAuditLog), Times.Once);
        ...
        {
            return GetLockForFileFails(() => FileAuditWorker.CreationEvent(ExpectedData),x => x.NewLog(It.IsAny<AuditableData>()), Times.Exactly(3));
        }
        ...
        {
            return GetLockForFileFails(() => FileAuditWorker.UpdateEvent(ExpectedData,OldExpectedData),x => x.UpdateLog(It.IsAny<AuditableData>(), It.IsAny<AuditableData>(), It.IsAny<AuditLog>()), Times.Exactly(3));
        }
        ...
        public bool UpdateEventWriteDataToStreamFails()
        {
            return WriteDataToStreamFails(() => FileAuditWorker.UpdateEvent(ExpectedData,OldExpectedData),
                ...
                UpdateExpectedAuditLog, Times.Exactly(3),Times.Exactly(6));
        }

        [Test(Author = "PackDB Creator", ExpectedResult = false)]
        public bool UpdateEventWriteDataToStreamFailsDueToException()
        {
            return WriteDataToStreamFailsDueToException(() => FileAuditWorker.UpdateEvent(ExpectedData,OldExpectedData),
                x => x.UpdateLog(It.IsAny<AuditableData>(), It.IsAny<AuditableData>(), It.IsAny<AuditLog>()),
                UpdateExpectedAuditLog, Times.Exactly(3), Times.Exactly(6));
        }
        ...
        public bool UpdateEventGenerateAuditFailsDueToException()
        {
            return GenerateAuditFailsDueToException(() => FileAuditWorker.UpdateEvent(ExpectedData,OldExpectedData),
                x => x.UpdateLog(It.IsAny<AuditableData>(), It.IsAny<AuditableData>(), It.IsAny<AuditLog>()), Times.Exactly(6));
        }
        ...
        {
            return GetLockForFileFails(() => FileAuditWorker.DeleteEvent(ExpectedData),x => x.DeleteLog(It.IsAny<AuditableData>(), It.IsAny<AuditLog>()), Times.Exactly(3));
        }
        ...
        public bool DeleteEventWriteDataToStreamFails()
        {
            return WriteDataToStreamFails(() => FileAuditWorker.DeleteEvent(ExpectedData),
                ...
                DeleteExpectedAuditLog, Times.Exactly(3),Times.Exactly(6));
        }
        ...
        {
            return GetLockForFileFails(() => FileAuditWorker.UndeleteEvent(ExpectedData),x => x.UndeleteLog(It.IsAny<AuditableData>(), It.IsAny<AuditLog>()), Times.Exactly(3));
        }
        ...
        public bool UndeleteEventWriteDataToStreamFails()
        {
            return WriteDataToStreamFails(() => FileAuditWorker.UndeleteEvent(ExpectedData),
                ...
                UndeleteExpectedAuditLog, Times.Exactly(3),Times.Exactly(6));
        }
        ...
        {
            return GetLockForFileFails(() => FileAuditWorker.RollbackEvent(ExpectedData),x => x.RollbackLog(It.IsAny<AuditableData>(), It.IsAny<AuditLog>()), Times.Exactly(3));
        }
        ...
        public bool RollbackEventWriteDataToStreamFails()
        {
            return WriteDataToStreamFails(() => FileAuditWorker.RollbackEvent(ExpectedData),
                ...
                RollbackExpectedAuditLog, Times.Exactly(3),Times.Exactly(6));
        }
